 ...
 * class TreeNode<T> {
	...
	public static TreeNode<Integer> findNextLargerNode(TreeNode<Integer> root, int n){
        ...
        for(int i=0;i<root.children.size();i++){
            TreeNode<Integer> nextLarInChild = findNextLargerNode(root.children.get(i),n);
            
            if(nextLarInChild != null){
                if(nextLargest == null || nextLargest.data > nextLarInChild.data){
                    nextLargest = nextLarInChild;
                }
