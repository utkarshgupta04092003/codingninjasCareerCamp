...
path from 8 to 9(inclusive of both). Hence the diameter according to the 
...
public class Solution {
    ...
    private static int findDiameter(BinaryTreeNode<Integer>root,int dia[]){
        ...
        dia[0] = Math.max(dia[0],leftHeight+rightHeight+1);
