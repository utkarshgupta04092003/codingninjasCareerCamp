...
The input tree when represented in a two-dimensional plane, it would 
look like this: 
Image link - https://files.codingninjas.in/system-upload-10352.jpg
alt txt

In respect to the root, node data in the left subtree that satisfy 
the condition of not having a sibling would be 6, taken in a top-down
...
siblings from the right subtree, taken in a top-down fashion, we print 6 7.
