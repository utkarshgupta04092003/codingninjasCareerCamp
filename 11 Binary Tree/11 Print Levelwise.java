...
Example:
Image link - https://files.codingninjas.in/0000000000004189.png
alt text
...
Note: There is no space in between while printing the information for 
each node.
Input Format:
...
public class Solution {
	...
	public static void printLevelWise(BinaryTreeNode<Integer> root) {
        ...
        while(!queue.isEmpty()){
            ...
            System.out.print(":L:"+(front.left == null ? -1 : front.left.data));
            System.out.println(",R:"+(front.right == null ? -1 : front.right.data));
