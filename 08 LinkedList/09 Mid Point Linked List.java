...
the nodes present at the middle with respective data values are,
20 and 30. We return the first node with data 20.
 Input format :
...
of the singly linked list and hence, would never be a list element
 Output Format :
For each test case/query, print the data value of the node at
the middle of the given list.
...
public class Solution {
   ...
   private static LinkedListNode<Integer> mid(LinkedListNode<Integer> fast,LinkedListNode<Integer> slow){
