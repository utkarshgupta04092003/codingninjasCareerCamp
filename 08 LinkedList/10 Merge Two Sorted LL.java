...
of the first sorted singly linked list separated by a single space. 
...
end of the singly linked list and hence, would never be a list
element
Output :
For each test case/query, print the resulting sorted singly 
