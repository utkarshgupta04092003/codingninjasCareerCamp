...
You have been given a linked list of integers. Your task is
to write a function that deletes a node from a given
position, 'POS'.
Note :
Assume that the Indexing for the linked list always starts
from 0.

If the position is greater than or equal to the length of 
the linked list, you should return the same linked list 
without any change.
Illustration :
...
Note:
You are not required to print the output, it has already been
...
public class Solution {
    ...
    public static LinkedListNode<Integer> deleteNode(LinkedListNode<Integer> head, int pos) {
        ...
        // if we want to delete 0th node
        if(pos == 0){
        	return head.next;   
        }
        
        // if position is greater than length of ll
        if(pos > len-1)
    		return head;
        
        
        // if we have to delete node inside of ll
