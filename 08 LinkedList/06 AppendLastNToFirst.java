...
number of nodes to be moved from last to the front of the singly
linked list.
Remember/Consider :
While specifying the list elements for input, -1 indicates the 
end of the singly linked list and hence, would never be a list element.
Output format :
...
initial list which is, "10->6->77" is attached after 100. Hence, the 
new list formed with an updated head pointing to 90.
 ...
 public static int length(LinkedListNode<Integer> head){
	...
	public static LinkedListNode<Integer> appendLastNToFirst(LinkedListNode<Integer> head, int n) {
       ...
       for(int i=0;i<n;i++){
        ...
        LinkedListNode<Integer> newStart = start.next;
        start.next = null;
        end.next = initial;
        return newStart;
