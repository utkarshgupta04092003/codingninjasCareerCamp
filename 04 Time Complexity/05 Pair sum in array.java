...
For the second query, we have 2 pairs in total that sum up to 10. They are, (2, 8) and 
(5, 5).
	...
	public static int pairSum(int[] arr, int num) {
        ...
        while(startIndex < endIndex){
            ...
            if(arr[startIndex] + arr[endIndex] < num){
                ...
                int totalElementFromStart = startIndex-tempStartIndex;
                int totalElementFromEnd = tempEndIndex-endIndex;
