...
public class Solution {	
    ...
    public static int pairSum(int[] arr,int start,int end,int sum){
        int numPair = 0;
        ...
        while(start < end){
            if(arr[start]+arr[end] < sum){
                ...
                if(elementAtStart == elementAtEnd){
                    int totalElementFromStartToEnd = end-start+1;
                ...
                int totalElementFromStart = (tempStart - start);
                int totalElementFromEnd = (end - tempEnd);
